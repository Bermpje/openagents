              ...
              {manifest && (
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  ...
                  <dl className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <dt className="text-gray-500 dark:text-gray-400">网络名称</dt>
                      <dd className="text-gray-900 dark:text-gray-100">
                        {manifest.network_name}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-gray-500 dark:text-gray-400">导出时间</dt>
                      <dd className="text-gray-900 dark:text-gray-100">
                        {new Date(manifest.export_timestamp).toLocaleString("zh-CN")}
                      </dd>
                    </div>
                    ...
                    <div>
                      <dt className="text-gray-500 dark:text-gray-400">模块数量</dt>
                      <dd className="text-gray-900 dark:text-gray-100">
                        {manifest.mods_count}
                      </dd>
                    </div>
                  ...
                  {manifest.notes && (
                    <div className="mt-2">
                      <dt className="text-sm text-gray-500 dark:text-gray-400">备注</dt>
              ...
              {preview && (
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-2 text-sm">
                    <div>
                      <span className="text-gray-500 dark:text-gray-400">网络名称: </span>
                    ...
                    {preview.mods_to_add.length > 0 && (
                      <div>
                        <span className="text-gray-500 dark:text-gray-400">新增模块: </span>
                        <span className="text-gray-900 dark:text-gray-100">
                    ...
                    {preview.mods_to_update.length > 0 && (
                      <div>
                        <span className="text-gray-500 dark:text-gray-400">更新模块: </span>
                        <span className="text-gray-900 dark:text-gray-100">
